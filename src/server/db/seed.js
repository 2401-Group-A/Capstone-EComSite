...
async function addSeeds() {
  ...
  ('Pepper', 'Green Bell (California Wonder)', 'Vegetable', '24-30 inches', '18-24 inches', '18-24 inches', '¼ - ½ inch', '60-70 days (green), 70-80 days (red)', 'Full Sun', 'src/client/assets/plants/bell_pepper.jpg', '500 Seeds', 4.99, 'Green Bell (California Wonder) Pepper produces large, blocky peppers with thick walls and sweet flavor, perfect for stuffing, salads, or grilling.', 'Start seeds indoors 6-8 weeks before transplanting. Stake or cage plants for support.'),
